...
Page({
      ...
      'id':that.data.id,
        ...
        if (res.data.s) {
            if(res.data.data && res.data.data!=''){ 
                ...
                console.log(res.data.data.formid)
                if(res.data.data.formid && res.data.data.formid !='null'){
                  that.lookDetectInfoChange(res.data.data.formid);
                }else if(res.data.data.detectcode && res.data.data.detectcode !='null'){
                  that.lookDetectInfoChange(res.data.data.detectcode);
                }
            }
        }else{
          wx.showModal({
  ...
  //查询检测信息
  lookDetectInfoChange(id){
    let that = this;
    hrp.GetDetectByFromid({ 
      'formid':id,
    }).then((res) => {
        console.log(res.data);
        if (res.data.s) {
